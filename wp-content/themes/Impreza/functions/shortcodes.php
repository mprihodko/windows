...
.$attributes['el_class'].'">
	...
	public function vc_latest_posts($attributes, $content)
	{
		...
		$output = 	'<div class="w-shortblog cols_'.$attributes['posts'].' date_atleft'.$attributes['el_class'].'">
			...
			$output .= 		'<div class="w-shortblog-entry">
								<div class="w-shortblog-entry-h">
									...
									<div class="w-shortblog-entry-meta">
										<div class="w-shortblog-entry-date">
											<span class="w-shortblog-entry-date-month">'.get_the_date('M').'</span>
											<span class="w-shortblog-entry-date-day">'.get_the_date('d').'</span>
											<span class="w-shortblog-entry-date-year">'.get_the_date('Y').'</span>
										</div>
									</div>
									<div class="w-shortblog-entry-short">'.$excerpt.'</div>
								</div>
							</div>';
		}
		$output .=		'</div>
