...
$of_options[] = array( "name" => "Custom Item Icon",
	"desc" => "Paste FontAwesome Icon name in&nbsp;this field. <a href='http://fontawesome.io/icons/' target='_blank'>Full list of icons</a>",
...
$of_options[] = array( "name" => "Menu Height",
	"desc" => "Stretch menu items to the full height of the header",
	"id" => "menu_height",
	"std" => 1,
	"type" => "switch");

$of_options[] = array( "name" => "Menu Hover Effect",
	"desc" => "Display underline on hover",
...
$of_options[] = array( 	"name" => "Post Pages",
	"id" => "blog_options_post_pages",
	"std" => 1,
	"type" => "subheading");
$of_options[] = array( "name" => "Sidebar Position",
	"desc" => "Select sidebar position or disable sidebar at post pages",
	"id" => "post_sidebar_pos",
	"std" => "Right",
	"type" => "select",
	"options" => array(
...
$of_options[] = array( "name" => "Author Box",
	"desc" => "Show box with information about post author",
	"id" => "post_author_box",
	"std" => 0,
	"type" => "switch");
$of_options[] = array( "name" => "Prev/Next Navigation",
	"desc" => "Show links to previous/next posts",
	"id" => "post_nav",
	"std" => 0,
	"type" => "switch");
$of_options[] = array( "name" => "Related Posts",
	"desc" => "Show list of posts with same tags at every post page",
	"id" => "post_related_posts",
	"std" => 1,
	"type" => "switch");

$of_options[] = array( 	"name" => "Default Front Page",
	"id" => "blog_options_front_page",
	"std" => 1,
	"type" => "subheading");
$of_options[] = array( "name" => "Sidebar Position",
	"desc" => "Select sidebar position or disable sidebar at Default Front page",
	"id" => "blog_sidebar_pos",
	"std" => "Right",
	"type" => "select",
	"options" => array(
...
$of_options[] = array( "name" => "Page Layout",
	"desc" => "Select layout for Search Default Front page",
	"id" => "blog_layout",
	"std" => "Large Image",
	"type" => "select",
	"options" => array(
...
$of_options[] = array( "name" => "Posts Content",
	"desc" => "Select type of posts content that will be display at Default Front page",
	"id" => "blog_excerpt",
	"std" => "Excerpt",
	"type" => "select",
	"options" => array('Excerpt' => 'Excerpt', 'Full Content of Post' => 'Full Content of Post', 'No Content' => 'No Content'));
$of_options[] = array( "name" => "Posts Meta",
	"id" => "blog_options_posts_meta",
	"std" => 1,
	"type" => "title");
$of_options[] = array( "name" => "",
	"desc" => "Date",
...
$of_options[] = array( 	"name" => "Archive Pages",
	"id" => "blog_options_archive",
	"std" => 1,
	"type" => "subheading");
$of_options[] = array( "name" => "Sidebar Position",
	"desc" => "Select sidebar position or disable sidebar at Archive pages",
...
$of_options[] = array( "name" => "Page Layout",
	"desc" => "Select layout for Search Archive pages",
	"id" => "archive_layout",
	"std" => "Large Image",
	"type" => "select",
	"options" => array(
...
$of_options[] = array( "name" => "Posts Content",
	"desc" => "Select type of posts content that will be display at Archive pages",
	"id" => "archive_excerpt",
	"std" => "Excerpt",
	"type" => "select",
	"options" => array('Excerpt' => 'Excerpt', 'Full Content of Post' => 'Full Content of Post', 'No Content' => 'No Content'));
$of_options[] = array( "name" => "Posts Meta",
	"id" => "blog_options_post_meta2",
	"std" => 1,
	"type" => "title");
$of_options[] = array( "name" => "",
	"desc" => "Date",
...
$of_options[] = array( 	"name" => "Search Results Page",
	"id" => "blog_options_search_results",
	"std" => 1,
	"type" => "subheading");
$of_options[] = array( "name" => "Sidebar Position",
	"desc" => "Select sidebar position or disable sidebar at Search Results page",
...
$of_options[] = array( "name" => "Posts Content",
	"desc" => "Select type of posts content that will be display at Search Results page",
	"id" => "search_excerpt",
	"std" => "Excerpt",
	"type" => "select",
	"options" => array('Excerpt' => 'Excerpt', 'Full Content of Post' => 'Full Content of Post', 'No Content' => 'No Content'));
$of_options[] = array( "name" => "Posts Meta",
	"id" => "blog_options_post_meta3",
	"std" => 1,
	"type" => "title");
$of_options[] = array( "name" => "",
	"desc" => "Date",
...
$of_options[] = array( 	"name" => "Excerpt",
	...
	"type" => "subheading");
$of_options[] = array( "name" => "Excerpt Length",
	"desc" => "Input amount of words in the Excerpt",
	"id" => "blog_excerpt_length",
	"std" => "40",
	"type" => "text");*/
