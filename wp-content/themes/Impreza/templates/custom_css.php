...
.headerpos_fixed .l-header {
	min-width: <?php echo ($smof_data['site_canvas_width'] != '')?$smof_data['site_canvas_width']:'1240'; ?>px;
	}
.l-canvas.type_boxed,
.l-canvas.type_boxed .l-subheader,
.l-canvas.type_boxed ~ .l-footer .l-subfooter {
	max-width: <?php echo ($smof_data['site_canvas_width'] != '')?$smof_data['site_canvas_width']:'1240'; ?>px;
	}
.l-subheader-h,
.l-submain-h,
.l-subfooter-h {
...
.l-content {
	width: <?php echo ($smof_data['content_width'] != '')?$smof_data['content_width']:'70'; ?>%;
	}
...
.l-header.transparent .w-nav-title:after {
	background-color: <?php echo ($smof_data['transparent_header_text_hover'] != '')?$smof_data['transparent_header_text_hover']:'#fff'; ?>;
	}
...
.l-header.transparent .type_desktop .w-nav-item.level_1.current-menu-ancestor .w-nav-anchor.level_1 {
	color: <?php echo ($smof_data['transparent_menu_active_text'] != '')?$smof_data['transparent_menu_active_text']:'#ff6ba9'; ?>;
	}
